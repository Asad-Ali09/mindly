...
`;
      ...
      const messages = [
        new SystemMessage('You are an expert AI tutor who creates assessment questions. Return only valid JSON without any markdown formatting or code blocks.'),
...
`;
      ...
      const messages = [
        new SystemMessage('You are an expert AI tutor who creates personalized lesson plans. Return only valid JSON without any markdown formatting or code blocks.'),
        new HumanMessage(prompt),
      ];
...
`;
      ...
      const messages = [
        new SystemMessage('You are an expert AI tutor who creates whiteboard content with drawings and captions. Return only valid JSON without any markdown formatting or code blocks.'),
        new HumanMessage(prompt),
      ];
...
`;
      ...
      const messages = [
        new SystemMessage('You are an expert AI tutor answering student questions. Return only valid JSON without any markdown formatting or code blocks.'),
        new HumanMessage(prompt),
      ];
