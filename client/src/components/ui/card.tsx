...
const Card = React.forwardRef<HTMLDivElement, CardProps>(
  ({ className, variant, title, description, children, ...props }, ref) => {
    const DotsPattern = () => {
      const sharedClasses =
        "rounded-full outline-8 outline-offset-0 sm:my-6 md:my-8 size-1 my-4 outline-[#0A0B09] bg-[#bf3a0d] transition-all duration-300 group-hover:scale-150 group-hover:shadow-[0_0_8px_rgba(191,58,13,0.6)]"

      return (
        <>
          <div className="absolute left-0 top-4 -z-0 h-px w-full bg-[#bf3a0d]/40 transition-all duration-300 group-hover:bg-[#bf3a0d]/60 group-hover:h-[2px] sm:top-6 md:top-8" />
          <div className="absolute bottom-4 left-0 z-0 h-px w-full bg-[#bf3a0d]/40 transition-all duration-300 group-hover:bg-[#bf3a0d]/60 group-hover:h-[2px] sm:bottom-6 md:bottom-8" />

          <div className="relative w-full border-x border-[#bf3a0d]/40 transition-colors duration-300 group-hover:border-[#bf3a0d]/60">
            <div className="absolute z-0 grid h-full w-full items-center">
              <section className="absolute z-0 grid h-full w-full grid-cols-2 place-content-between">
                <div className={`${sharedClasses} -translate-x-[2.5px]`} style={{ outline: '8px solid #0A0B09' }} />
                <div
                  className={`${sharedClasses} translate-x-[2.5px] place-self-end`} 
                  style={{ outline: '8px solid #0A0B09' }}
                />
                <div className={`${sharedClasses} -translate-x-[2.5px]`} style={{ outline: '8px solid #0A0B09' }} />
                <div
                  className={`${sharedClasses} translate-x-[2.5px] place-self-end`} 
            ...
            <div className="relative z-20 mx-auto py-8">
              <CardContent>
                {title && (
                  <h3 className="text-lg font-bold mb-1 text-[#fafafa] transition-colors duration-300 group-hover:text-[#bf3a0d]">
                    {title}
                  </h3>
                )}
                {description && (
                  <p className="text-[#fafafa]/70 transition-colors duration-300 group-hover:text-[#fafafa]/90">
                    {description}
                  </p>
                )}
                {children}
    ...
    if (variant === "dots") {
      return (
        <div
          ref={ref}
          className={cn(cardVariants({ variant, className }), "group")}
          {...props}
        >
          <div className="absolute left-0 top-4 -z-0 h-px w-full bg-[#bf3a0d]/40 transition-all duration-300 group-hover:bg-[#bf3a0d]/60 group-hover:h-[2px] sm:top-6 md:top-8" />
          <div className="absolute bottom-4 left-0 z-0 h-px w-full bg-[#bf3a0d]/40 transition-all duration-300 group-hover:bg-[#bf3a0d]/60 group-hover:h-[2px] sm:bottom-6 md:bottom-8" />
          <div className="relative w-full border-x border-[#bf3a0d]/40 transition-colors duration-300 group-hover:border-[#bf3a0d]/60">
            <div className="absolute z-0 grid h-full w-full items-center">
              <section className="absolute z-0 grid h-full w-full grid-cols-2 place-content-between">
                <div className="rounded-full sm:my-6 md:my-8 size-1 my-4 bg-[#bf3a0d] -translate-x-[2.5px] transition-all duration-300 group-hover:scale-150 group-hover:shadow-[0_0_8px_rgba(191,58,13,0.6)]" style={{ outline: '8px solid #0A0B09' }} />
                <div className="rounded-full sm:my-6 md:my-8 size-1 my-4 bg-[#bf3a0d] translate-x-[2.5px] place-self-end transition-all duration-300 group-hover:scale-150 group-hover:shadow-[0_0_8px_rgba(191,58,13,0.6)]" style={{ outline: '8px solid #0A0B09' }} />
                <div className="rounded-full sm:my-6 md:my-8 size-1 my-4 bg-[#bf3a0d] -translate-x-[2.5px] transition-all duration-300 group-hover:scale-150 group-hover:shadow-[0_0_8px_rgba(191,58,13,0.6)]" style={{ outline: '8px solid #0A0B09' }} />
                <div className="rounded-full sm:my-6 md:my-8 size-1 my-4 bg-[#bf3a0d] translate-x-[2.5px] place-self-end transition-all duration-300 group-hover:scale-150 group-hover:shadow-[0_0_8px_rgba(191,58,13,0.6)]" style={{ outline: '8px solid #0A0B09' }} />
              </section>
            </div>
